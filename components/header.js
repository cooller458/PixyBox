...
export default function Header(props) {
  ...
  const headers = [
    ...
    { name: " Crate NFT BOX", href: "/creare-nft-box" },
    { name: " Create NFT", href: "/create-nft-pinta" },
    { name: " Categories", href: "/categories" },
    { name: "NFT Bridge", href: "https://bridge.balancenetwork.io/" },
    { name: "Whitepaper", href: "/PixyBoxWhitePaperr.pdf" },
  ];
