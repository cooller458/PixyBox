                ...
                <div key={item.itemId} className='w-full h-auto grid grid-cols-1 bg-[#161A42] border-2 border-[#161A42] dark:bg-white dark:border-2 dark:border-gray-200 rounded-2xl text-white dark:text-gray-800 '>
                    <div className='grid grid-cols-1 gap-2 p-4'>
                        ...
                        <Link href={{
                            ...
                            <img src={item.allCate === "MYSTERY" ? "../assets/png/PixyBoxRevisedTransparant.png": item.image} alt={item.allCate === "MYSTERY" ? "../assets/png/PixyBoxRevisedTransparant.png": "item.image"} className='w-full h-auto'></img>
                            </Link>
                        </div>
