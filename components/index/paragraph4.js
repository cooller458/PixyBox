...
export default function Paragraph4() {
  ...
  useEffect(() => {
    const LoadContracts = async () => {
      ...
      console.log(nftNetWorkObject,"obje");
      //Get Token Contract
          ...
          const items = await Promise.all(
            data.map(async (item) => {
              ...
              let myItem = {
                ...
                image: metaData.data.category === "MYSTERY" ? "assets/png/PixyBoxRevisedTransparant.png" : metaData.data.image,
