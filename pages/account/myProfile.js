        ...
        const LoadContracts = async () => {
            ...
            if (nftMarketWorkObject && nftMarketWorkObject) {
                ...
                if (account) {
                    ...
                    console.log("unPanItems My Profile", unPanItems)
                    console.log("items My Profile", items)
                ...
                <div className='w-full 2xl:max-w-screen-2xl h-auto pt-[104px] m-auto'>
                    <div className='flex flex-col mx-8 sm:mx-16 lg:mx-[9vw] space-y-6 py-12'>
                        ...
                        <div className='flex flex-col space-y-6'>
                            <div className='relative h-[200px] rounded-md bg-[#e42876] '>
                                ...
                                <div className='absolute left-1/2 bottom-0 -translate-x-1/2 translate-y-1/2 w-[112px] h-[112px] rounded-full bg-[#e42876] '></div>
                            </div>
                            ...
                            <div className='flex flex-row pt-16'>
                                ...
                                <div className='flex-grow flex flex-col items-center space-y-6 text-white dark:text-gray-800 text-center'>
                                    ...
                                    <div className="flex flex-row space-x-4 text-[#e42876] text-2xl mr-3">
                                        <button onClick={() => { navigator.clipboard.writeText(`https://www.BNBnft.app/account/${account}`) }}
                                        >
                                    ...
                                    <div className='flex flex-row space-x-2'>
                                        {btnCategories.map((item, index) => (
                                            <button key={"btn-category" + index.toString()} className={classNames(index === current ? 'bg-[#ffffff] dark:bg-gray-800 text-black' : 'border border-[#2C3166] dark:border-gray-400 bg-[#002046] dark:bg-white text-[#919CC1] dark:text-gray-800', 'text-xs rounded-full px-4 py-1.5')} onClick={() => {
                                                setCurrent(index)
                                                setCategory(item)
                                            }}>{item}</button>
                                        ))}
