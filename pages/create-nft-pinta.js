...
import BnbBg from "../public/bnb.png";
                            ...
                            <div className='w-full lg:w-[40%] flex-none flex flex-col space-y-4'>
                              ...
                              onChange = {e=>setNftFormInput({...nftFormInput,name:e.target.value})}
                                ...
                                <div className='relative text-[#B4BAEF]'>
                                    ...
                                    ></input>
                                    <p className='absolute top-1/2 right-8 -translate-y-1/2 text-sm'>BNB</p>
                                  
                                </div>



                            <textarea className='text-[#B4BAEF] text-sm p-3.5 rounded-md border border-[#9FA4FF] bg-[#212760] dark:bg-white focus:outline-none focus:ring-2' rows="6" placeholder='Description'
