...
export default function CreateNftPage() {
  ...
  const createMarketForSale = async (url) => {
    ...
    if (nftMarketWorkObject && nftMarketWorkObject) {
      ...
      console.log("You are at Wrong Network");
    }
  };
          ...
          <div className="flex flex-col mx-8 sm:mx-12 lg:mx-[9vw] space-y-6 py-12 text-white dark:text-gray-800">
            ...
            <div className="flex flex-col lg:flex-row items-center">
              ...
              <div className="w-full lg:w-[40%] flex-none flex flex-col space-y-4">
                ...
                <input
                  className="text-[#B4BAEF] text-sm p-3.5 rounded-md border border-[#9FA4FF] bg-[#000000] dark:bg-white focus:outline-none focus:ring-2"
                ...
                <select
                  className="text-[#B4BAEF] text-sm px-3.5 py-3 rounded-md border border-[#9FA4FF] bg-[#000000] dark:bg-white focus:outline-none focus:ring-2 appearance-none custom-select"
                  placeholder="NFT Title"
                  defaultValue={0}
                  id="nft-category"
                  onChange={(e) =>
                ...
                <div className="relative text-[#B4BAEF]">
                  <input
                    className="w-full text-sm p-3.5 pr-16 rounded-md border border-[#9FA4FF] bg-[#000000] dark:bg-white focus:outline-none focus:ring-2"
                    type="number"
                    min={0}
                    placeholder="Price"
                    id="nft-price"
                ...
                {isActive ? (
                  <button
                    className="rounded-full bg-[#e42876]  text-white text-base px-6 sm:px-10 py-2 shadow-md m-auto"
                    id="btn-create-nft"
                ...
                <div className="relative w-full h-auto">
                  ...
                  <div className="absolute left-0 top-1/2 -translate-y-1/2  w-[57.5%] h-full flex flex-col items-start p-3 sm:p-6 lg:p-4 xl:p-8">
                    ...
                    <div className="flex-none flex flex-row items-center  w-full">
                      ...
                      <p className="flex-grow text-white text-sm sm:text-xl"></p>
                      <p className="flex-grow text-white text-sm sm:text-xl"></p>
                    </div>
                      ...
                      <div className="flex-1 flex flex-col space-y-1">
                        ...
                        <div className="flex-grow flex flex-row space-x-2 text-xs sm:text-base lg:text-sm xl:text-base">
                          <div className="flex-1 flex flex-row items-center">
                            <div className="flex-none font-bold"></div>
