                    ...
                    <div className='flex flex-col space-y-6'>
                        ...
                        <div className='flex flex-row items-center space-x-4 rounded-md bg-[#000000] dark:bg-white border-2 border-[#262645] dark:border-2 dark:border-gray-200 p-4'>
                            ...
                            <div className='flex-grow flex-col'>
                              ...
                              {purchasedItems.length>0?  <p className='text-[#53CEC7] dark:text-gray-600 text-sm font-bold'>You Purchased {purchasedItems.length} NFTS</p>: <p className='text-[#53CEC7] dark:text-gray-600 text-sm font-bold'>Start To Purchased Items Now</p>}
                            </div>
                        </div>
