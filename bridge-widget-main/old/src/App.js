...
<div className="setting_sidebar">
			...
			<div className="sidebar_content">
				...
				<div className="setting_list accordion" id="settingAccordial">

					<div className="accordion-item">
						<h2 className="accordion-header" id="smart_connect_head">
							<button className="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#smart_connect" aria-expanded="true" aria-controls="smart_connect">
								Smart contract support
							</button>
						</h2>
						<div id="smart_connect" className="accordion-collapse collapse show" aria-labelledby="smart_connect_head">
					...
					<div className="accordion-item">
						<h2 className="accordion-header" id="blockChain_head">
							<button className="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#blockChain" aria-expanded="false" aria-controls="blockChain">
								Integrated Blockchains
							</button>
						</h2>
						<div id="blockChain" className="accordion-collapse collapse" aria-labelledby="blockChain_head">
							<div className="accordion-body">
					...
					<div className="accordion-item">
						<h2 className="accordion-header" id="themStyleHead">
							<button className="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#themStyle" aria-expanded="false" aria-controls="themStyle">
					...
					<div className="accordion-item">
						<h2 className="accordion-header" id="Typography_head">
							<button className="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#TypographyOpt" aria-expanded="false" aria-controls="TypographyOpt">
								Typography
							</button>
						</h2>
						<div id="TypographyOpt" className="accordion-collapse collapse" aria-labelledby="Typography_head">
							<div className="accordion-body">
								<div className="typographyContainer">
									<div className="typographyBox ">
										...
										<div className="typo-sel font-select">
											...
											<div className="select_font">
												<div className="dropdown">
													<button className="btn dropdown-toggle" type="button" id="selectFontHeader" data-bs-toggle="dropdown" aria-expanded="false">
														Roboto
													</button>
													<ul className="dropdown-menu" aria-labelledby="selectFontHeader">
										...
										<div className="typo-sel font-size-sel">
											...
											<div className="select_font">
												<div className="dropdown">
													<button className="btn dropdown-toggle" type="button" id="selectHeaderFont" data-bs-toggle="dropdown" aria-expanded="false">
														Large (28px)
													</button>
													<ul className="dropdown-menu" aria-labelledby="selectHeaderFont">
									...
									<div className="typographyBox ">
										...
										<div className="typo-sel font-select">
											...
											<div className="select_font">
												<div className="dropdown">
													<button className="btn dropdown-toggle" type="button" id="selectBodyFont" data-bs-toggle="dropdown" aria-expanded="false">
														Roboto
													</button>
													<ul className="dropdown-menu" aria-labelledby="selectBodyFont">
														<li><a className="dropdown-item" href="#">Open Sance</a></li>
														<li><a className="dropdown-item" href="#">Inter</a></li>
													</ul>
												</div>
										...
										<div className="typo-sel font-size-sel">
											...
											<div className="select_font">
												<div className="dropdown">
													...
													<ul className="dropdown-menu" aria-labelledby="selectBodyFont">
														<li><a className="dropdown-item" href="#">Medium (20px)</a></li>
														<li><a className="dropdown-item" href="#">Normal (16px)</a></li>
													</ul>
												</div>
											</div>
					...
					<div className="accordion-item">
						<h2 className="accordion-header" id="Buttons_head">
							<button className="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#Buttons_style" aria-expanded="false" aria-controls="Buttons_style">
								Buttons
							</button>
						</h2>
						<div id="Buttons_style" className="accordion-collapse collapse" aria-labelledby="Buttons_head">
							<div className="accordion-body">
					...
					<div className="accordion-item">
						<h2 className="accordion-header" id="exportcode_head">
							<button className="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#Exportcode" aria-expanded="false" aria-controls="Exportcode">
								Export code
							</button>
						</h2>
						<div id="Exportcode" className="accordion-collapse collapse" aria-labelledby="exportcode_head">
							<div className="accordion-body">
